...
*** Test Cases ***
To verify user is able to delete white list
    ...
    And Verify the black/white list is present in the list table    ${TestWhiteListNameEdited}  ${TestWhiteListDescriptionEdited}
    When Click the delete icon of the black/white list    ${TestWhiteListNameEdited}
